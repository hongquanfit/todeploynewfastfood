$(function() {
    function notification(type, message, icon=null){
        var html = `
            <div class="col-md-2 text-center notification noti-${type}">
                <p class="mt-3">
                    <i class="fa fa-${icon?'info':icon}"></i>
                    <b id="notiMessage">${message}</b>
                </p>
            </div>
        `;
        $('body').append(html);
